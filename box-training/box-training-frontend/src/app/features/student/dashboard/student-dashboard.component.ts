...
import { QuickActionsGridComponent, QuickAction } from '../../../shared/components/quick-actions-grid/quick-actions-grid.component';
...
export class StudentDashboardComponent implements OnInit {
  ...
  private loadDashboardData(): void {
    ...
    if (activePlan) {
      ...
      const upcomingReservations = this.mockDataService.getStudentFutureReservations(this.currentUser.id);
