...
import { User, UserRole, LoginDto, LoginResponse } from '../models'
...
export class AuthService {
  ...
  constructor(private mockDataService: MockDataService, @Inject(PLATFORM_ID) platformId: Object) {
  ...
  private validatePassword(password: string, role: UserRole): boolean {
    // Usar las contraseñas centralizadas del MockDataService
    const mockPasswords = this.mockDataService.getMockPasswords()
